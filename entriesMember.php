...
if(getUserIdFromSession() == true) {
    ...
    if ($entries == NULL) {
        ...
        foreach ($entries as $entry => $blogs) {
            ...
            echo $content.'...';
            echo '<a href="index.php?function=entriesMemberDetails&bid='.$blogId.'&eid='.$blogs['eid'].'">Blog anzeigen </a>';
            echo '<a onclick="return confirmDelete()" href="index.php?function=entriesMemberDelete&bid='.$blogId.'&eid='.$blogs['eid'].'">Blog Löschen </a>';
            echo '<a href="index.php?function=entriesMemberEdit&bid='.$blogId.'&eid='.$blogs['eid'].'">Blog bearbeiten </a>';
            echo "<br>"."<br>";
        }
    }
} else {
